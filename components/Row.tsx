...
function Row({title, movies}: Props) {
    ...
    <div className="h-40 space-y-0.5 md:space-y-2">
        ...
        <div className="relative group md:-ml-2">
            <ChevronLeftIcon 
                className={`absolute top-0 bottom-0 left-2 z-40 m-auto h-9 w-9 cursor-pointer transition opacity-0 hover:scale-125 group-hover:opacity-100 ${!isMoved && 'hidden'}`} 
